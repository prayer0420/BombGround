...
public class bl_LoadingScreenUI : MonoBehaviour
{
    ...
    public void ResetUI()
    {
        ...
        FadeImageCanvas.alpha = 1;
        _ = StartCoroutine(FadeOut(FadeImageCanvas, 0.2f, () => FadeImageCanvas.gameObject.SetActive(false)));
    ...
    private IEnumerator FadeOut(CanvasGroup fadeImageCanvas, float v, System.Action value)
    {
