...
public class SoundTool : EditorWindow
{
                    ...
                    this.SP2 = EditorGUILayout.BeginScrollView(this.SP2);
                    {
                        if(soundData.GetDataCount() > 0)
                        {
                            EditorGUILayout.BeginVertical();
                            {
                                ...
                                this.soundSource = (AudioClip)EditorGUILayout.ObjectField("AudioClip", this.soundSource, typeof(AudioClip), false, GUILayout.Width(uiWidthLarge));
                                ...
                                if(soundSource != null )
                                {
                                    ...
                                    sound.minDistance = EditorGUILayout.FloatField("minDistance", sound.minDistance, GUILayout.Width(uiWidthLarge));
                                    sound.maxDistance = EditorGUILayout.FloatField("maxDistance", sound.maxDistance, GUILayout.Width(uiWidthLarge));
    ...
    public void CreatEnumStructre()
    {
        ...
        for (int i = 0; i < soundData.names.Length; i++)
        {
            ...
            {
                builder.Append("     " + soundData.names[i] + " = " + i.ToString() + ",");
