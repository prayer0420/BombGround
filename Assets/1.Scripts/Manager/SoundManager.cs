...
{
    public const string MastgerGroupName = "Master";
    ...
    public const string ContainerName = "SoundContainer"; //오디오 리스너, 채널을 가지고 있음
    ...
    void Start()
    {
        ...
        if(this.mixer != null)
        {
            ...
            this.UI_audio.outputAudioMixerGroup = mixer.FindMatchingGroups(BGMGroupName)[0];
