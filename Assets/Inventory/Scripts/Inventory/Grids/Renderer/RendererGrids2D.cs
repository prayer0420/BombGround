...
namespace Inventory.Scripts.Inventory.Grids.Renderer
{
    public class RendererGrids2D : RendererGrids
    {
        ...
        private static void HandleRectTransform(Transform parentTransform, Component containerGridsInstantiated)
        {
