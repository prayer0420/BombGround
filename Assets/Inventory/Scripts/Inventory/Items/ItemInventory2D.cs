...
using Inventory.Scripts.Inventory.Items.Utils;
...
namespace Inventory.Scripts.Inventory.Items
{
    public class ItemInventory2D : AbstractItem
    {
        ...
        public override void ResizeIcon()
        {
            ...
            GetRectTransformFromDisplayName().sizeDelta = _rectTransform.sizeDelta;
        }
        ...
        protected override void RotateUI()
        {
            ...
            rectTransform.rotation =
                Quaternion.Euler(0, 0, ItemTable.IsRotated ? RotationUtils.GetRotationByType(rotationType) : 0f);
            ...
            var localPositionHeight = ItemTable.IsRotated ? _displayNameRectTransform.sizeDelta.y : 0;
